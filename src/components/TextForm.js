...
export default function TextForm(props) {
  ...
  return (
   ...
   <div className="conatainer" style={{color: props.mode==='dark'?'white':'black'}}> 
        ...
        <button className="btn btn-primary mx-1 my-1" onClick={handleLoClick}>Convert to Lowerase</button>
        <button className="btn btn-primary mx-1 my-1" onClick={handleblank}>Clear</button>
